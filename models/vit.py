...
if __name__=='__main__':
    x = torch.rand(1,64*4,64,64)
    model = PixelwiseViT(features=64*4,n_heads=4,n_blocks=2,ffn_features=64*8,embed_features=64*4,norm='layer',activ='gelu',image_shape=(64*4,64,64))
    y = model(x)
    print(y.size())