...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset-path',
        dest='dataset_path',
        help='Which folder to process (it should have subfolders trainA, trainB, trainA and trainB'
    )
    ...
    test_a_path = os.path.join(dataset_folder, 'trainA')
    test_b_path = os.path.join(dataset_folder, 'trainB')
